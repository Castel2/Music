...
/*
  @author Castel...
 */
public class Contrasena_Usuario_GUI extends javax.swing.JFrame {

     Adm_usuarios_DB usuDB = new Adm_usuarios_DB();
     conexion conex = new conexion();
     
    public Contrasena_Usuario_GUI() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("".equals(cedula1.getText())||"".equals(contrasena.getText())) {
            ...
            Usuario_sistema usuario = new Usuario_sistema(Integer.parseInt(cedula1.getText()),contrasena.getText());
            boolean var = true;
            if (var) {
                usuDB.mostrar(usuario);
