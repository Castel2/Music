...
/*
  @author Castel...
 */
public class Busqueda_Id_VIP_GUI extends javax.swing.JFrame {

    Adm_Busqueda_Canciones_DB busquedaNombre = new Adm_Busqueda_Canciones_DB();
    conexion conex = new conexion();
    
    public Busqueda_Id_VIP_GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(identificador, new org.netbeans.lib.awtextra.AbsoluteConstraints(75, 114, 99, 22));
        ...
        getContentPane().add(identificador1, new org.netbeans.lib.awtextra.AbsoluteConstraints(268, 109, 107, 31));
        ...
        getContentPane().add(descargar, new org.netbeans.lib.awtextra.AbsoluteConstraints(272, 158, -1, -1));

        jLabel1.setFont(new java.awt.Font("Comic Sans MS", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 0, 0));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("BUSQUEDA POR ID");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 26, 377, 65));
        ...
        getContentPane().add(buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 154, -1, -1));
        getContentPane().add(resultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(99, 201, 163, 34));
        ...
        getContentPane().add(volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(299, 216, 76, 19));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 480, 280));
