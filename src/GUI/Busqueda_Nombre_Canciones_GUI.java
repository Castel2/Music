...
/*
  @author Castel...
 */
public class Busqueda_Nombre_Canciones_GUI extends javax.swing.JFrame {
    
    Adm_Busqueda_Canciones_DB busquedaNombre = new Adm_Busqueda_Canciones_DB();
    conexion conex = new conexion();
    
    public Busqueda_Nombre_Canciones_GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -60, 620, 480));
